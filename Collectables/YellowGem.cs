...
namespace RaceGame
{
    class YellowGem : Gem  //The class should inherit from the Gem class.
    {
        ...
        /// </summary>
        public YellowGem(SceneManager mSceneMgr, Stat score)
            : base(mSceneMgr, score) //. The class constructor should call the base constructor using :base(mSceneMgr, score)
        {
            ...
            increase = 5;  //initialize the increase field inherited from Gem 
        ...
        protected override void LoadModel() //The class should override the LoadModel method from Gem
        {
            ...
            gemEntity.SetMaterialName("yellow");
            

            gemNode = mSceneMgr.CreateSceneNode();
            gemNode.Scale(new Vector3(1.5f, 1.5f, 1.5f));
